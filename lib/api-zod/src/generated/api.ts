...
export const ListPanelsResponseItem = zod.object({
  ...
  "column_labels": zod.array(zod.string()).optional().describe('Custom column labels in visual order'),
  "row_labels": zod.array(zod.string()).optional().describe('Custom row labels in visual order'),
  ...
  "diagram_tint": zod.string().regex(listPanelsResponseDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
...
export const CreatePanelBody = zod.object({
  ...
  "columns": zod.number(),
  "rows": zod.number(),
  "column_start": zod.string().optional(),
  "row_start": zod.string().optional(),
  "column_labels": zod.array(zod.string()).optional(),
  "row_labels": zod.array(zod.string()).optional(),
  ...
  "diagram_tint": zod.string().regex(createPanelBodyDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
...
export const CreatePanelResponse = zod.object({
  ...
  "diagram_tint": zod.string().regex(createPanelResponseDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
...
export const GetPanelResponse = zod.object({
  ...
  "diagram_tint": zod.string().regex(getPanelResponseDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
...
export const UpdatePanelBody = zod.object({
  ...
  "diagram_offset_y": zod.number().optional(),
  "diagram_opacity": zod.number().optional(),
  "diagram_tint": zod.string().regex(updatePanelBodyDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
  "grid_offset_x": zod.number().optional(),
  "grid_offset_y": zod.number().optional(),
  "column_widths": zod.array(zod.number()).optional(),
  "row_heights": zod.array(zod.number()).optional(),
...
export const UpdatePanelResponse = zod.object({
  ...
  "diagram_tint": zod.string().regex(updatePanelResponseDiagramTintRegExp).nullish().describe('Optional hex color tint applied to the panel diagram for the current user'),
...
export const ListAuditCapturesResponseItem = zod.object({
  ...
  "grid_col": zod.number(),
  "grid_col_label": zod.string().optional(),
  "grid_row": zod.string(),
