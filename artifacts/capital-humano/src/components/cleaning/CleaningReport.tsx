    ...
    <>
      ...
      >
        <button
          type="button"
          className={cn(
            "cursor-zoom-in bg-white p-2",
            compact ? "block w-full" : "flex min-h-0 flex-1 items-center justify-center",
          )}
          ...
          .cleaning-report .report-action-bar { display: none; }
           ...
           .cleaning-report .report-checklist-heading { display: none !important; }
            .cleaning-report .checklist-sheet {
             ...
             .cleaning-report .checklist-sheet img { max-height: 242mm !important; }
        }
      `}</style>
