...
type Area = { id: number; code: string; name: string; description?: string; area_type: string; activities: AreaActivity[] };
...
function ActivityPhoto({ activity, onUploaded }: { activity: FlowActivity; onUploaded: (path: string) => void }) {
  ...
  return <div className="col-span-2 pl-8 md:order-3 md:flex-1 md:pl-0"><PhotoButton label="Tomar foto de la actividad" value={activity.initial_photo || activity.final_photo} onUploaded={onUploaded} /></div>;
}
